...
There is an inherent amount of risk associated with changing the `regional.db` and so I will not be publishing a demonstration version until a script with fail safes has been developed.
